...
class ItemList {
  ...
  String getProductName(index) {
    return _items[index].productName;
  }
  ...
  String? getFrom(index) {
    return _items[index].from;
  }

  String? getNutrients(index) {
    return _items[index].nutrients;
  }

  String? getQuantity(index) {
  ...
  bool? getOrganic(index) {
    return _items[index].organic;
  }
